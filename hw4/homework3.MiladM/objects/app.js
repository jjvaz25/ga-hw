...
//console.log(calendarObj.things);
...
let pet_owner1 = new pet_owner('Milad', 'Toronto');
console.log('pet_owner name: '+ pet_owner1.name + '  address: ' + pet_owner1.address);
///new
let pet_owner2=('Milad', { street: '123 first st', city: 'Toronto' });
console.log(pet_owner2);
