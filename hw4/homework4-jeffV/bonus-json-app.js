...
let backtojson = JSON.parse(grungeAlbumsJSON)
// console.log(backtojson)
console.log(backtojson.albums[0])
...
for (let i = 0; i < backtojson["albums"].length; i++) {
  console.log(`album: ${backtojson["albums"][i]["name"]}`)
  console.log(`artist: ${backtojson["albums"][i]["artist"]}`)
  console.log(`units sold: ${backtojson["albums"][i]["unitsSold"]}`)
  console.log('')
}
